(function ($) {
    ...
    $('#canvas').bind('init', function() {
      
        var $video = $('#video');
        canvas_width = $video.width();
        canvas_height = $video.height() - 30;
        ...
        t.init(ctx);
        for (var i = 0; i < 3; i++) {
            new Branch(new Vector(center_x, canvas_height), new Vector(Math.random(-1, 1), -y_speed), 15 / stretch_factor, 'white', t);
        }
        t.render(function () {
